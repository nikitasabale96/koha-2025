...
class __TwigTemplate_be7e4ec51c6f7c1effc910a06d975829 extends Template
{
  ...
  ";
    ...
    ";
        ...
        // line 12
        yield "    ";
        if (((($tmp = ($context["copyright_text"] ?? null)) && $tmp instanceof Markup ? (string) $tmp : $tmp) || (($tmp = ($context["social_icons"] ?? null)) && $tmp instanceof Markup ? (string) $tmp : $tmp))) {
            // line 13
            yield "      ";
