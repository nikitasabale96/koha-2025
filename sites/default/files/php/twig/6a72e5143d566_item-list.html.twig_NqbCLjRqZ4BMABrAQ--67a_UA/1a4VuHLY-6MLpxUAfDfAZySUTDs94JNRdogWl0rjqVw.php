...
/* item-list.html.twig */
class __TwigTemplate_9fcf867d0957068caf7aa7ab67ba3d28 extends Template
{
        ...
        if (((($tmp = ($context["items"] ?? null)) && $tmp instanceof Markup ? (string) $tmp : $tmp) || (($tmp = ($context["empty"] ?? null)) && $tmp instanceof Markup ? (string) $tmp : $tmp))) {
            ...
            if ((($tmp = ($context["items"] ?? null)) && $tmp instanceof Markup ? (string) $tmp : $tmp)) {
                ...
                foreach ($context['_seq'] as $context["_key"] => $context["item"]) {
                    // line 33
                    yield "<li";
                    yield (string) $this->extensions['Drupal\Core\Template\TwigExtension']->escapeFilter($this->env, CoreExtension::getAttribute($this->env, $this->source, $context["item"], "attributes", [], "any", false, false, true, 33), "html", null, true);
                    yield ">";
                    yield (string) $this->extensions['Drupal\Core\Template\TwigExtension']->escapeFilter($this->env, CoreExtension::getAttribute($this->env, $this->source, $context["item"], "value", [], "any", false, false, true, 33), "html", null, true);
                    yield "</li>";
                }
    ...
    {
        return array (  85 => 37,  80 => 35,  69 => 33,  65 => 32,  60 => 31,  58 => 30,  53 => 27,  51 => 26,  49 => 25,  46 => 23,  44 => 22,);
    }
