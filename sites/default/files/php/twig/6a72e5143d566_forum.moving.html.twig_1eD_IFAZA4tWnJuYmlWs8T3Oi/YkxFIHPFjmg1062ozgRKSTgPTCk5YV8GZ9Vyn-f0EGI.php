...
class __TwigTemplate_4cec4232f8272912db1f12817cdbe617 extends Template
{
...
<p>";
        // line 9
        yield t("Move a forum topic and all of its comments to a new forum.", []);
        yield "</p>
<h2>";
        // line 10
        yield t("Steps", []);
...
<ol>
  ...
  <li>";
        // line 15
        yield t("In the <em>Forums</em> field, select the new forum that you want the topic to move to.", []);
        yield "</li>
  <li>";
        // line 16
        yield t("Check <em>Leave shadow copy</em> to create a link in the original forum pointing to the new location.", []);
        yield "</li>
  <li>";
        // line 17
    ...
    {
        return new Source("", "@help_topics/forum.moving.html.twig", "/var/www/html/Koha-2025/modules/forum/help_topics/forum.moving.html.twig");
    }
