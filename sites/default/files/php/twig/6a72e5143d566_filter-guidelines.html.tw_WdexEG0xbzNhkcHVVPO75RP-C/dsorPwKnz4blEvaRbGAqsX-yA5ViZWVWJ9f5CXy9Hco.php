...
class __TwigTemplate_fb8c3c4bc44d6c7c043adff29d9bfe0d extends Template
{
...
($context["format"] ?? null), "id", [], "any", false, false, true, 23)))];
  ...
  <h4 class=\"label\">";
        // line 27
        yield (string) $this->extensions['Drupal\Core\Template\TwigExtension']->escapeFilter($this->env, CoreExtension::getAttribute($this->env, $this->source, ($context["format"] ?? null), "label", [], "any", false, false, true, 27), "html", null, true);
        yield "</h4>
  ";
        // line 28
...
";
    ...
    {
        return new Source("", "core/themes/claro/templates/filter/filter-guidelines.html.twig", "/var/www/html/Koha-2025/core/themes/claro/templates/filter/filter-guidelines.html.twig");
    }
