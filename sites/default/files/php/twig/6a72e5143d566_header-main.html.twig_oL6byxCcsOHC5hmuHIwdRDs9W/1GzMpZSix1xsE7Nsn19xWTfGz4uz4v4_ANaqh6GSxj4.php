...
class __TwigTemplate_cceeeebe6583c2677bd956d0956ae26d extends Template
{
    ...
    <div class=\"header-main-container full-width\">
      ";
        ...
        if ((($tmp = CoreExtension::getAttribute($this->env, $this->source, ($context["page"] ?? null), "site_branding", [], "any", false, false, true, 4)) && $tmp instanceof Markup ? (string) $tmp : $tmp)) {
          ...
          ";
            // line 6
            yield (string) $this->extensions['Drupal\Core\Template\TwigExtension']->escapeFilter($this->env, CoreExtension::getAttribute($this->env, $this->source, ($context["page"] ?? null), "site_branding", [], "any", false, false, true, 6), "html", null, true);
            yield "
        </div>
      ";
        }
        // line 9
        yield "      ";
        if (((($tmp = CoreExtension::getAttribute($this->env, $this->source, ($context["page"] ?? null), "primary_menu", [], "any", false, false, true, 9)) && $tmp instanceof Markup ? (string) $tmp : $tmp) || (($tmp = CoreExtension::getAttribute($this->env, $this->source, ($context["page"] ?? null), "header_search", [], "any", false, false, true, 9)) && $tmp instanceof Markup ? (string) $tmp : $tmp))) {
            // line 10
            ...
            <div class=\"header-search-wrap\">
              <div class=\"header-search-block header-search-section\">
                ...
                <div class=\"container\">
                  ";
                // line 35
                yield (string) $this->extensions['Drupal\Core\Template\TwigExtension']->escapeFilter($this->env, CoreExtension::getAttribute($this->env, $this->source, ($context["page"] ?? null), "header_search", [], "any", false, false, true, 35), "html", null, true);
                yield "
                </div>
              </div>
